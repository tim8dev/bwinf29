...
/**
 * Ein Kartensatz, z.B. der Handkartensatz
 * Definiert Funktionen zur Berechnung
 *  (a) der Durchschnittspunktzahl
 *      (für eine Zahl oder alle Zahlen gewichtet nach Wahrscheinlichkeit)
 *  (b) der Möglichkeiten für Streichsätze einer gegebenen Zahl,
 *  (c) eines neuen Kartensatz nach Streichung eines Anderen.
 */
