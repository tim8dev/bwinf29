...
/**
 * Abstrakter Button mit Position und Radius
 * Kollidierbar mit anderen Buttons
 * @author Tim Taubner
 */
@ThreadSafe
...
// Die Position in einem thread-sicherem Container:
...
public boolean collidesWith(Button o) {
    if(this == o) return false; // Nicht mit sich selbst kollidierbar.
    // Ist Abstand < Summe der Radien?
