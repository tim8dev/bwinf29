...
\titleformat{\chapter}[display]{\normalfont\sffamily}{\normalfont 29.\ BWINF, 2.\ Runde; Einsendung:\ Tim Taubner, Nr.\ 29.0108.01}{18pt}{\Huge\bfseries \thechapter.\ }
...
%\renewcommand*\stctitle{\bfseries\Large Programmtexte}
%\nostcrule
...
\subsection{Ausführen der Beispiele}
 Alle Beispiele können nacheinander ausgeführt werden, indem im Wurzelverzeichnis der CD |./examples| (|examples.bat| unter Windows) in der Konsole eingeben wird.
 Die Beispiele können auch nach Aufgabe getrennt ausgeführt werden,
  nämlich durch Eingabe von |./aufgabe1| (|aufgabe1.bat| unter Windows) bzw.\ |./aufgabe2| (|aufgabe2.bat| unter Windows).
\clearpage
