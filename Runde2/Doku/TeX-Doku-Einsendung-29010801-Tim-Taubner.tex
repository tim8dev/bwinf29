...
\subsection{Ausführen der Beispiele}
 Alle Beispiele können nacheinander ausgeführt werden, indem Sie im Wurzelverzeichnis der CD |./examples| in der Konsole eingeben.
 Die Beispiele können auch nach Aufgabe getrennt ausgeführt werden, indem Sie |./aufgabe1| oder |./aufgabe2| eingeben.
 (Unter Windows jeweils .bat an die Befehle hängen.)
\clearpage
